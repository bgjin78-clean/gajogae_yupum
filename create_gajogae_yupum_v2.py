...
<section class="price" id="price">
  <div class="wrap">
    <div class="section-title">
      ...
      <p>표시 금액은 기본 안내 금액이며, 정확한 비용은 현장 확인 후 작업 범위에 따라 안내드립니다.</p>
    </div>
    ...
    <div class="price-notice">현장 구조와 물품 양에 따라 비용이 달라질 수 있습니다.</div>
  </div>
</section>
"""
...
FAQ_PATTERNS = {
    "부산": [
        ("부산 유품정리 비용은 어떻게 정해지나요?", "유품정리는 25만원부터, 고독사청소는 80만원부터, 폐기물처리는 1톤 1대 기준 25만원부터 안내드리며, 아파트·빌라·주택 구조와 엘리베이터, 폐기물 양에 따라 달라질 수 있습니다."),
        ("부산 구도심 주택도 가능한가요?", "골목길이나 계단 작업이 필요한 현장도 상담 후 진행 가능합니다."),
        ("부산 고독사청소도 함께 가능한가요?", "냄새, 오염, 장기 방치 흔적이 있는 경우 특수청소와 함께 안내합니다."),
    ],
    "울산": [
        ("울산 유품정리 비용은 어떻게 정해지나요?", "유품정리는 25만원부터, 고독사청소는 80만원부터, 폐기물처리는 1톤 1대 기준 25만원부터 안내드리며, 아파트·단독주택·외곽 주거지와 물품 양에 따라 달라질 수 있습니다."),
        ("울산 울주군 외곽 지역도 가능한가요?", "울주군 외곽 주택과 농촌형 주거지도 상담 가능합니다."),
        ("울산 특수청소도 가능한가요?", "오염, 냄새, 방치 흔적이 있는 현장은 현장 확인 후 진행 범위를 안내합니다."),
    ],
    "경남": [
        ("경남 유품정리 비용은 어떻게 정해지나요?", "유품정리는 25만원부터, 고독사청소는 80만원부터, 폐기물처리는 1톤 1대 기준 25만원부터 안내드리며, 지역·주거 형태·물품 양·반출 동선·소독 필요 여부에 따라 달라질 수 있습니다."),
...
def make_region_page(name, slug, group, feature):
    ...
    desc = f"{name} 유품정리, 고독사청소, 특수청소 상담. 유품정리 25만원부터, 고독사청소 80만원부터, 폐기물처리 1톤 1대 기준 25만원부터 안내드립니다. {BRAND} {PHONE}"
